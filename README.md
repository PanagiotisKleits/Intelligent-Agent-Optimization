...
The core of this agent's stability lies in its reward shaping. I replaced binary "step rewards" with a continuous mathematical function to ensure the agent is always trying to reach the absolute center, not just "stay on the board."I used the following formula for the reward (r):
